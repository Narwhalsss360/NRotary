...
#define CCW_STATE_OFFESET 3

#define INVERTABLE(i_cond, expr) ((i_cond) ? !expr : expr)

const constexpr byte nextTimeState[7][4] =
{
	{ 0, 1, + CCW_STATE_OFFEST, 0 },
	{ 2, 1, 0, 0 },
	{ 2, 1, 3, 0 },
	{ 2, 0, 3, CW },

	{ 2, + CCW_STATE_OFFSET, 0, 1 + CCW_STATE_OFFEST, 0 },
	{ 2 + CCW_STATE_OFFEST, 3 + CCW_STATE_OFFSET, 1 + CCW_STATE_OFFSET, 0 },
	{ 2 + CCW_STATE_OFFSET, 3 + CCW_STATE_OFFEST, 0, CCW }
};
